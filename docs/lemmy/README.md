# Lemmy (LMy): Academic Content Creation Pipeline

**Lemmy** is EventAI's comprehensive system for creating publication-ready academic textbook content. It orchestrates a complete workflow from question formulation through deep research, narrative generation, visual content creation, validation, and DOCX publishing.

## Philosophy

- **Quality First**: 100% data accuracy, 90%+ visual quality scores, zero tolerance for sideramps
- **Systematic Validation**: Triple validation gates (claim verification, visual evaluation, question alignment)
- **Tier-Aware Visuals**: Concise/Standard/Detailed density framework with text pattern enforcement
- **Tool Integration**: 17 Claude commands + 3 CLI tools + utility scripts for end-to-end automation
- **Evidence-Based**: All claims verified against primary sources, all visuals evaluated quantitatively
...
- **Complete WBS**: [workflows/CONTENT-PIPELINE-WBS-SUMMARY.md](workflows/CONTENT-PIPELINE-WBS-SUMMARY.md)
- **Visual Identity**: [style-guide/eventai-visual-identity.md](style-guide/eventai-visual-identity.md)
- **Infographic Best Practices**: [research/infographics-best-practices.md](research/infographics-best-practices.md)
- **Beads Issues**: `bd list --status=open | grep -E "Phase|eventai"`
...
**Purpose**: Systematic documentation of the EventAI academic content creation pipeline
**Focus**: Current implementation and derived structure (future milestones will further abstract)
