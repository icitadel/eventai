...
# When Sports Venue Evidence Doesn't Transfer to Festivals
...
**Why this works:** Crowd density follows physics regardless of venue type. Festival deployments prove it. High opt-in rates show attendees accept it. You can do this without surveillance.
...
**Word Count:** ~1,400 words (vs. 3,100 in draft 1)
**Terse Factor:** 54% reduction while preserving all key evidence
