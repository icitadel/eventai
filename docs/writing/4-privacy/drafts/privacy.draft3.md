...
**Context**: This question examines consent, data retention, misidentification, function creep, and chilling effects associated with AI surveillance technologies. It asks experts to articulate the balance between safety imperatives and civil liberties, informed by documented incidents and regulatory frameworks.
...
**Figure 4.1: Privacy vs Safety Trade-Off Matrix** — Regulatory framework showing when biometric surveillance is appropriate, conditional, constrained, or illegal based on threat level and privacy intrusion.
...
**Figure 4.2: Consent Architecture Spectrum** — GDPR-compliant consent patterns showing coercive (illegal), problematic (gray area), and voluntary (compliant) approaches to biometric data collection.
...
**Figure 4.3: EU AI Act Risk Classification** — Three-tier framework showing prohibited, high-risk, and limited-risk AI systems under EU regulation.
...
**Figure 4.4: GDPR Biometric Compliance Decision Tree** — Five-checkpoint framework for evaluating biometric system legality at festival entry gates.
