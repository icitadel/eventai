# Festival Biometric Consent Models

Comparison of three consent architectures for biometric systems at festivals.
...
- Colors: Red (#FF6B6B) for coercive, orange (#ED8936) for problematic, green (#48BB78) for compliant
- White space: 30%+ composition
- Typography: 16pt body text, 20pt model labels, clean sans-serif
- Context: Festival entry gates, wristbands, facial recognition cameras

## Structure

Three-column comparison chart. Each column shows one consent model with icon, definition, implementation details, and legal status. Bottom section cites GDPR articles.
